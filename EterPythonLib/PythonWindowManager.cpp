...
#ifdef UPDATE_TELEPORT_CRASH
	void CWindowManager::__ClearReserveDeleteWindowList()
	{
		// Výše uvedený kód není potřeba, protože si myslím, že jej stejně čistíme z vektoru. // Opraveno
		//// Powyższy kod nie jest potrzebny, ponieważ myślę, że i tak usuwamy go z wektora. // Naprawił
