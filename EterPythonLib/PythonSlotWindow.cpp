...
/*/
	//marked half of item fix sklepy
		if (IS_SET(rSlot.dwState, SLOT_STATE_DISABLE))
		{
			CPythonGraphic::Instance().SetDiffuseColor(1.0f, 0.0f, 0.0f, 0.3f);
	...
	//marked half of item fix sklepy
		...
		if (rSlot.bActive)
		{
			...
			else if (m_pSlotActiveEffectSlot2 && rSlot.byyPlacedItemSize == 2)
			{
				...
				m_pSlotActiveEffectSlot2->SetDiffuseColor(rSlot.d3Color.r, rSlot.d3Color.g, rSlot.d3Color.b, rSlot.d3Color.a);
			...
			else if (m_pSlotActiveEffectSlot3 && rSlot.byyPlacedItemSize == 3)
			{
				...
				m_pSlotActiveEffectSlot3->SetDiffuseColor(rSlot.d3Color.r, rSlot.d3Color.g, rSlot.d3Color.b, rSlot.d3Color.a);
