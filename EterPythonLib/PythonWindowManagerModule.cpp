...
PyObject * wndTextSetFontDynamic(PyObject * poSelf, PyObject * poArgs)
{
	UI::CWindow * pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
	{
	...
	((UI::CTextLine*)pWindow)->SetFontDynamic(flag);
	return Py_BuildNone();
}
#endif
...
PyObject* wndButtonSetAlwaysExecuteOverFunc(PyObject* poSelf, PyObject* poArgs)
{
	UI::CWindow* pWindow;
	if (!PyTuple_GetWindow(poArgs, 0, &pWindow))
		return Py_BuildException();
	...
	((UI::CButton*)pWindow)->SetAlwaysExecuteOverFunc(bVal);
	return Py_BuildNone();
}
...
void initwndMgr()
{
	static PyMethodDef s_methods[] =
	{
		...
		{ "SetAlwaysExecuteOverFunc",	wndButtonSetAlwaysExecuteOverFunc,	METH_VARARGS },
...
#ifdef ENABLE_DYNAMIC_FONTS
		{ "SetDynamicFont",				wndTextSetFontDynamic,					METH_VARARGS },
#endif
