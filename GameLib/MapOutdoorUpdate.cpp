...
#ifndef LALAKER_FIX_MEMORYLEAK
	__CollectCollisionShadowReceiver(v3Player, v3Light); //@natanek2
#endif
...
#ifdef MEMORY_LEAK_FIX
	PCBlocker_SInstanceList (PCBlocker_CDynamicSphereInstanceVector* pkDSIVector) : m_pkDSIVector (pkDSIVector), m_dwInstCount (0), m_dwBlockerCount (0), m_dwBlockerOverCount (0)
#else
