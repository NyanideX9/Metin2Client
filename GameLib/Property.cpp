 ...
 *  5 ~ 6 bytes: \r\n
 *
 *  ±× ŔĚČÄŔÇ ąŮŔĚĆ®µéŔş ĹŘ˝şĆ® ĆÄŔĎ ·Î´őżÍ °°Ŕş ±¸Á¶
 */
...
// NOTE : ·ąĆŰ·±˝şżˇ´Â ŔĚ·± ˝ÄŔ¸·Î ÇĎ°Ô˛ű µÇľî ŔÖŔ˝
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////
// ÇĺµĄ ±×·ˇµµ Ć¨±č. - [levites]
//	std::copy(it->second.begin(), it->second.end(), rTokenVector.begin());

// °á±ą ŔĚ·¸°Ô.. - [levites]
// ÇöŔç »çżëÇĎ´Â °÷ : WorldEditor/Dialog/MapObjectPropertyPageBuilding.cpp
