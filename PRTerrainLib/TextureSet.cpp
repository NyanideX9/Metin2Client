...
/*/
	...
	//@natanek53
		if (!c_szFileName)
		{
			LogBox("CTextureSet::SetTexture: Błąd - Brak nazwy pliku. Przekazany wskaźnik na nazwę pliku jest niezdefiniowany (nullptr).", "Błąd");
			return false;
		}
	//@natanek53
...
/*/
	...
	{
		TraceError("CTextureSet::SetTexture: Nie można ustawić tekstury. Tekstura '%s' nie istnieje.", c_szFileName ? c_szFileName : "Nieznany");
		return false;
	}
	//@natanek53
							 ...
							 float fTerrainTexCoordBase)
{
		...
		if (!c_szFileName)
		{
			LogBox("CTextureSet::AddTexture: Błąd - Brak nazwy pliku. Przekazany wskaźnik na nazwę pliku jest niezdefiniowany (nullptr).", "Błąd");
			return false;
		}
		//@natanek53
...
/*/
	...
	if (!pResource || !pResource->IsType(CGraphicImage::Type()))
	{
		TraceError("CTextureSet::AddTexture: Nie można ustawić tekstury. Tekstura '%s' nie istnieje", c_szFileName ? c_szFileName : "Nieznany");
		return false;
	}
	//@natanek53
