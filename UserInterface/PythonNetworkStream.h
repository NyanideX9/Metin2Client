...
class CPythonNetworkStream : public CNetworkStream, public CSingleton<CPythonNetworkStream>
{
	public:
		...
		enum
		{
			...
			ACCOUNT_CHARACTER_SLOT_LAST_PLAYTIME, //@natanek25
...
//		bool SendExchangeItemAddPacket(TItemPos ItemPos, BYTE byDisplayPos);
		bool SendExchangeItemAddPacket(TItemPos ItemPos, BYTE byDisplayPos, bool isRightClickAutoMoveEnabled); //@natanek135
...
//		bool SendSafeBoxCheckinPacket(TItemPos InventoryPos, BYTE bySafeBoxPos);
		bool SendSafeBoxCheckinPacket(TItemPos InventoryPos, BYTE bySafeBoxPos, bool isRightClickAutoMoveEnabled); //@natanek135
//		bool SendSafeBoxCheckoutPacket(BYTE bySafeBoxPos, TItemPos InventoryPos);
		bool SendSafeBoxCheckoutPacket(BYTE bySafeBoxPos, TItemPos InventoryPos, bool isRightClickAutoMoveEnabled); //@natanek135
...
//		bool SendMallCheckoutPacket(BYTE byMallPos, TItemPos InventoryPos);
		bool SendMallCheckoutPacket(BYTE byMallPos, TItemPos InventoryPos, bool isRightClickAutoMoveEnabled); //@natanek135
	...
	protected:
		...
		void HideQuestWindows(); //@natanek81
	...
	protected:
		...
		bool HandleQuestDestroyCommand(const std::string& str); //@natanek81
	...
	public:
		...
		bool SendItemShopBuyPacket(DWORD id, DWORD category, BYTE count, BYTE bonus_type);
		bool SendItemShopAddItemPacket(TItemShopItem item, BYTE flag);
		bool SendItemShopGetDailyRewardPacket();
	protected:
