...
void initapp()
{
	...
	PyModule_AddIntConstant(poModule, "ENABLE_TEXT_SHADOW",	1);
#else
	PyModule_AddIntConstant(poModule, "ENABLE_TEXT_SHADOW",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "EXTREME_FPS_BOOST", 1);
#else
	PyModule_AddIntConstant(poModule, "EXTREME_FPS_BOOST", 0);
#endif
...
#ifdef FIX_PLAYERS_LOAD
	//@natanek10
	PyModule_AddIntConstant(poModule, "FIX_PLAYERS_LOAD",	1);
#else
	PyModule_AddIntConstant(poModule, "FIX_PLAYERS_LOAD",	0);
#endif

#define __CHANGE_CHANNEL_SYSTEM__
#ifdef __CHANGE_CHANNEL_SYSTEM__
	PyModule_AddIntConstant(poModule, "__CHANGE_CHANNEL_SYSTEM__",	1);
#else
	PyModule_AddIntConstant(poModule, "__CHANGE_CHANNEL_SYSTEM__",	0);
#endif
	...
	PyModule_AddIntConstant(poModule, "__BL_ENVIRONMENT_EFFECT_OPTION__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_ENVIRONMENT_EFFECT_OPTION__", false);
#endif
...
#if defined(__BL_SLOT_TIME_INFO__)
	PyModule_AddIntConstant(poModule, "__BL_SLOT_TIME_INFO__", true);
#else
	PyModule_AddIntConstant(poModule, "__BL_SLOT_TIME_INFO__", false);
#endif
...
#ifdef LOTERIA_MOJA
	PyModule_AddIntConstant(poModule, "LOTERIA_MOJA",	1);
#else
	PyModule_AddIntConstant(poModule, "LOTERIA_MOJA",	0);
#endif
