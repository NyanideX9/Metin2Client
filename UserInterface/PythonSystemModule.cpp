...
PyObject * systemIsGreenTexturesMode(PyObject * poSelf, PyObject * poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().IsGreenTexturesMode());
}

PyObject * systemSetGreenTexturesMode(PyObject * poSelf, PyObject * poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetGreenTexturesMode(iFlag);
...
PyObject* systemGetTextShadowMode(PyObject* poSelf, PyObject* poArgs)
{
	return Py_BuildValue("i", CPythonSystem::Instance().GetTextShadowMode());
}

PyObject* systemSetTextShadowMode(PyObject* poSelf, PyObject* poArgs)
{
	int iFlag;
	if (!PyTuple_GetInteger(poArgs, 0, &iFlag))
		return Py_BuildException();

	CPythonSystem::Instance().SetTextShadowMode(iFlag);
...
void initsystemSetting()
{
	static PyMethodDef s_methods[] =
	{
...
#ifdef EXTREME_FPS_BOOST
		{ "SetExtremeFpsBoost", systemSetExtremeFpsBoost, METH_VARARGS },
		{ "GetExtremeFpsBoost", systemGetExtremeFpsBoost, METH_VARARGS },
#endif
		...
		{ "IsGreenTexturesMode", systemIsGreenTexturesMode, METH_VARARGS },
		{ "SetGreenTexturesMode", systemSetGreenTexturesMode, METH_VARARGS },
#endif
		...
		{ "SetNightMode",				systemSetNightMode,				METH_VARARGS },
			...
			{"SetCameraMode", systemSetCameraMode, METH_VARARGS}, //@natanek97
			{"GetCameraMode", systemGetCameraMode, METH_VARARGS}, //@natanek97
...
#ifdef ENABLE_TEXT_SHADOW
		{ "GetTextShadowMode",				systemGetTextShadowMode,				METH_VARARGS },
		{ "SetTextShadowMode",				systemSetTextShadowMode,				METH_VARARGS },
#endif
