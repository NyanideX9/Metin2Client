...
void CPythonCharacterManager::TouchViewBoundDistance(bool bVal) 
{
	m_viewBoundDistance = bVal ? CHAR_STAGE_VIEW_BOUND / 8 : CHAR_STAGE_VIEW_BOUND;
}
#endif
...
#ifndef LALAKER_FIX_MEMORYLEAK //@natanek2
				continue;
#endif
			}
...
#ifdef EXTREME_FPS_BOOST
			if (nDistance > m_viewBoundDistance + 10)
#else
...
void CPythonCharacterManager::__Initialize()
{
	...
	m_pkInstPick = NULL;
#ifdef EXTREME_FPS_BOOST
	m_viewBoundDistance = CHAR_STAGE_VIEW_BOUND;
#endif
