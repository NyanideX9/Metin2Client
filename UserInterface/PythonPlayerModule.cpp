...
void initPlayer()
{
	static PyMethodDef s_methods[] =
	{
		...
		{"DisableToggleSkill", playerDisableToggleSkill, METH_VARARGS},	//@natanek49
	...
	PyModule_AddIntConstant(poModule, "WEEKLY1",			POINT_WEEKLY1);
	PyModule_AddIntConstant(poModule, "WEEKLY2",			POINT_WEEKLY2);
	PyModule_AddIntConstant(poModule, "WEEKLY3",			POINT_WEEKLY3);
	PyModule_AddIntConstant(poModule, "WEEKLY4",			POINT_WEEKLY4);
	PyModule_AddIntConstant(poModule, "WEEKLY5",			POINT_WEEKLY5);
	PyModule_AddIntConstant(poModule, "WEEKLY6",			POINT_WEEKLY6);
	PyModule_AddIntConstant(poModule, "WEEKLY7",			POINT_WEEKLY7);
	PyModule_AddIntConstant(poModule, "WEEKLY8",			POINT_WEEKLY8);
	PyModule_AddIntConstant(poModule, "WEEKLY9",			POINT_WEEKLY9);
	PyModule_AddIntConstant(poModule, "WEEKLY_SEASON",		POINT_WEEKLY_SEASON);
#endif
