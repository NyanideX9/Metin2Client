...
bool CPythonNetworkStream::SendSafeBoxCheckinPacket(TItemPos InventoryPos, BYTE bySafeBoxPos, bool isRightClickAutoMoveEnabled) //@natanek135
{
	...
	kSafeboxCheckin.isRightClickAutoMoveEnabled = isRightClickAutoMoveEnabled; //@natanek135
...
bool CPythonNetworkStream::SendSafeBoxCheckoutPacket(BYTE bySafeBoxPos, TItemPos InventoryPos, bool isRightClickAutoMoveEnabled) //@natanek135
{
	...
	kSafeboxCheckout.isRightClickAutoMoveEnabled = isRightClickAutoMoveEnabled; //@natanek135
...
bool CPythonNetworkStream::SendMallCheckoutPacket(BYTE byMallPos, TItemPos InventoryPos, bool isRightClickAutoMoveEnabled) //@natanek135
{
	...
	kMallCheckoutPacket.isRightClickAutoMoveEnabled = isRightClickAutoMoveEnabled; //@natanek135
...
//	__GlobalPositionToLocalPosition(packet_item_ground_add.lX, packet_item_ground_add.lY);
		__GlobalPositionToLocalPosition(packet_item_ground_add.x, packet_item_ground_add.y); //@natanek46
