...
//	return LoadFromMemory((const BYTE*) pvMap);
	return LoadFromMemory((const BYTE*)pvMap, mappedFile.Size()); //@natanek103

}


//bool CDXTCImage::LoadHeaderFromMemory(const BYTE * c_pbMap)
bool CDXTCImage::LoadHeaderFromMemory(const BYTE* c_pbMap, size_t fileSize) //@natanek103
...
//		return false;
	...
	fileSize -= sizeof(DDSURFACEDESC2); //@natanek103
...
bool CDXTCImage::LoadFromMemory(const BYTE* c_pbMap, size_t fileSize) //@natanek103
