...
bool CGraphicFontTexture::Create(const char* c_szFontName, int fontSize, bool bItalic, bool bBold) //@natanek155
{
	Destroy();
...
//		logFont.lfWeight			= FW_NORMAL;
		logFont.lfWeight			= (m_bBold) ? FW_BOLD : FW_NORMAL; //@natanek155
