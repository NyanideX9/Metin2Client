...
class CGraphicTextInstance
{
	...
	public:
		...
		void DisableUpdate() { m_isUpdate = false; }
		void SetDynamicFont(bool f) { dynamic_font_off = f; }
		bool GetDynamicFontOff() const { return dynamic_font_off; }
	#endif
