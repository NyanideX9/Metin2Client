...
/*/
	...
	//@natanek100 - działa tylko na DX8
void CStateManager::SetDevice(LPDIRECT3DDEVICE8 lpDevice)
{
	StateManager_Assert(lpDevice);
	lpDevice->AddRef();
...
{
	SetAnisotropicFiltering(); //@natanek100
...
void CStateManager::SetAnisotropicFiltering() 
{
    ...
    DWORD dwMaxAnisotropy = d3dCaps.MaxAnisotropy;
    dwMaxAnisotropy = (dwMaxAnisotropy < 4) ? dwMaxAnisotropy : 4;
